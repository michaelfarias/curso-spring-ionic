...
import com.udemy.cursospring.dto.ProdutoDTO;
import com.udemy.cursospring.resources.utils.URL;
import com.udemy.cursospring.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(@RequestParam(value = "nome", defaultValue = "0") String nome,
		...
		Page<Produto> list = service.search(nomeDecoded, ids, page, linesPerPage, orderBy, direct);
